...
start /wait "" "c:\temp\SysAidInstall\SysAidAgent.exe" /VERYSILENT /URL https://wizo.sysaidit.com /account wizo /serial 34A24AB423CA87B7 /AllowRemoteControl N /SubmitSRShortcut "Wiza" /HotKey 624 /Interval 30 /ConfirmRC N /RandomMachineID N /AllowSubmitSR Y
